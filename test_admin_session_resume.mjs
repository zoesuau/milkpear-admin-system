...
function fixture(){
 ...
 const c={adminCreateOrderSubmitting:false,adminCreateProductsRefreshing:false,adminAddOrderOpening:false,Date,URLSearchParams,ADMIN_LINE_SESSION_TOKEN_KEY:'token',ADMIN_LINE_STATE_KEY:'state',ADMIN_AUTH_TIMEOUT_MS:60000,GAS_ORDERS_API_URL:'mock',adminAuthBlocksDataLoad:false,
